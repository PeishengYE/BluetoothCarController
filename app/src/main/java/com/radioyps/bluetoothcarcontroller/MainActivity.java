package com.radioyps.bluetoothcarcontroller;
...
//        setHasOptionsMenu(true);
        ...
        mAlarmButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View view){
                sendMessage("alarm");
            }
        });
    ...
    private void setStatus(CharSequence subTitle) {
        ...
        final ActionBar actionBar = getSupportActionBar();
        Log.d(TAG, "setStatus(CharSequence subTitle)>> ");
        if (null == actionBar) {
            return;
        }
        ...
        switch (requestCode) {
            case REQUEST_CONNECT_DEVICE_SECURE:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    Log.d(TAG, "onActivityResult()>> start Secure connetiong");
            ...
            case REQUEST_CONNECT_DEVICE_INSECURE:
                // When DeviceListActivity returns with a device to connect
                if (resultCode == Activity.RESULT_OK) {
                    Log.d(TAG, "onActivityResult()>> start a NOT Secure connetiong");
            ...
            case REQUEST_ENABLE_BT:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Log.d(TAG, "onActivityResult()>> just Enable BT, let's setup... ");
                    setupChat();
                } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.secure_connect_scan: {
                ...
                Log.d(TAG, "onOptionsItemSelected()>> start Secure connetiong");
            ...
            case R.id.insecure_connect_scan: {
                // Launch the DeviceListActivity to see devices and do scan
                Intent serverIntent = new Intent(this, DeviceListActivity.class);
                Log.d(TAG, "onOptionsItemSelected()>> start InSecure connetiong");
